...
- [PROJECT ARCHIVE Window Polish Guide](../phases/02-computer-ui/47-project-archive-window-polish-guide.md) — project viewer의 readable implementation archive spacing과 tech stack metadata 기준.
...
- project info는 `ROLE`, `TECH STACK`, `IMPLEMENTATION` 중심으로 압축하고 구현 세부는 spacing이 있는 subgroup으로 분리한다. 상세 기준은 [PROJECT ARCHIVE Window Polish Guide](../phases/02-computer-ui/47-project-archive-window-polish-guide.md)를 따른다.
