...
- Related Documents: [Boot Screen Editor Guide](../phases/02-computer-ui/33-boot-screen-editor-guide.md), [Shutdown Transition Plan](../phases/02-computer-ui/34-shutdown-transition-plan.md), [Window Transition Guide](../phases/02-computer-ui/35-window-transition-guide.md), [Taskbar Interaction Guide](../phases/02-computer-ui/36-taskbar-interaction-guide.md), [Desktop Icon Interaction Guide](../phases/02-computer-ui/37-desktop-icon-guide.md), [Future Transition Polish](../phases/02-computer-ui/38-future-transition-polish.md), [Computer UI Polish Roadmap](../phases/02-computer-ui/39-computer-ui-polish-roadmap.md), [Window Minimize Guide](../phases/02-computer-ui/40-window-minimize-guide.md), [Desktop Clock System Info Guide](../phases/02-computer-ui/41-desktop-clock-system-info-guide.md), [Fake OS Ambience Guide](../phases/02-computer-ui/42-fake-os-ambience-guide.md), [CRT Overlay Polish Guide](../phases/02-computer-ui/43-crt-overlay-polish-guide.md), [SYSTEM.LOG Diagnostic Reveal Guide](../phases/02-computer-ui/45-system-log-diagnostic-guide.md), [CONTACT.EXE Window Polish Guide](../phases/02-computer-ui/46-contact-window-polish-guide.md), [PROJECT ARCHIVE Window Polish Guide](../phases/02-computer-ui/47-project-archive-window-polish-guide.md), [Fake System Popup Editor Wiring](../phases/02-computer-ui/51-fake-system-popup-editor-wiring.md)
- Last Reviewed Phase: 47 PROJECT ARCHIVE Window Polish Guide
...
- [Desktop Clock System Info Guide](../phases/02-computer-ui/41-desktop-clock-system-info-guide.md) — clock-only system tray와 hover system info popup 연결 기준.
...
- [CRT Overlay Polish Guide](../phases/02-computer-ui/43-crt-overlay-polish-guide.md) — CanvasGroup 기반 CRT overlay alpha와 subtle flicker 연결 기준.
...
- [Resource Notes Room Document Viewer](../phases/04-room-interactions/01-resource-notes-document-viewer.md) — 방 오브젝트 상호작용 기반 문서 viewer 연결 기준.
- [Open URL Button Handler](../phases/04-room-interactions/02-open-url-button-handler.md) — 임의 UI Button에 붙이는 공용 URL 열기 컴포넌트 연결 기준.

관련 legacy/editor wiring 문서:

- [Desktop Icon Editor Wiring](../phases/02-computer-ui/10-desktop-icon-editor-wiring.md) — legacy 단일 project window wiring 기록. 현재 interaction 기준은 37번 문서를 우선한다.
...
- [Taskbar Window Management Design](../phases/02-computer-ui/18-taskbar-window-management.md) — taskbar/window lifecycle 설계 기록. 현재 visual state 기준은 36번 문서를 우선한다.
- [Taskbar Implementation Checklist](../phases/02-computer-ui/21-taskbar-editor-implementation-checklist.md) — runtime taskbar Editor wiring 완료 체크리스트.
...
- `BootScreenRoot`, `FakeSystemPopupRoot`, `ShutdownScreenRoot`는 desktop shell의 자식이 아닌 overlay 계층이다.
...
- `PROJECT ARCHIVE` 톤의 실제 프로젝트 탐색 앱이다.
- `ProjectData` 기반 project window로 표시한다.
- 프로젝트별 window는 독립적으로 열릴 수 있고 taskbar button과 1:1로 동기화된다.
- project info는 `ROLE`, `TECH STACK`, `IMPLEMENTATION` 중심으로 압축하고 project switch feedback과 explorer state를 제공한다. 상세 기준은 [PROJECT ARCHIVE Window Polish Guide](../phases/02-computer-ui/47-project-archive-window-polish-guide.md)를 따른다.
...
- 단일 scroll log viewer와 monospace text를 사용하며, diagnostic reveal 세부 기준은 [SYSTEM.LOG Diagnostic Reveal Guide](../phases/02-computer-ui/45-system-log-diagnostic-guide.md)를 따른다.
